...
async function main() {
    console.log('Sorting officer roles by code...');
    
    // Select all branch officers and union roles
    const res = await pool.query("SELECT id, code FROM master_data WHERE category IN ('branch_officer', 'union_role')");
